...
class RAEClient:
    ...
    def store_system_model(self, system_model_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = self._make_request(
                method="POST", endpoint="/v2/memories//system-model", data=system_model_payload
            )
    ...
    def get_memory_for_project(
        ...
        try:
            ...
            response = self._make_request(method="GET", endpoint="/v2/memories/query", params=params)
